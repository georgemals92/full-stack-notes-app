...
import { FilterIcon, Pen, Trash } from "lucide-react";
...
function App() {
  ...
  const [isCreateDialogOpen, setIsCreateDialogOpen] = useState<boolean>(false); // state for edit note modal
      ...
      <div className="flex">
        ...
        <Sidebar>
          ...
          <SidebarContent>
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => {
                        if (checked) {
                          ...
                          setFilterCategories(
                            filterCategories.filter((id) => id !== c._id)
                          );
                        }
                      }}
                    />
            ...
            <SidebarFooter>
              <Button variant="default" onClick={() => loadNotes(buildQuery())}>
                Apply
              </Button>
              <Button
                variant="secondary"
            ...
            <div className="flex items-center gap-1">
              ...
              >
                ...
                <DialogContent className="w-[550px] flex flex-col gap-y-4">
                  ...
                  >
                    <div>
                      <Label className="my-2" htmlFor="title-create">
                        Title
                      </Label>
                      <Input
                        id="title-create"
                      ...
                      <ScrollArea className=" max-h-40 overflow-y-auto">
                        {allCategories.map((c) => (
                          ...
                          >
                            ...
                            <Label
                              className="cursor-pointer font-normal"
                              htmlFor={`cat-select-create-${c._id}`}
                            >
                              {c.name}
                            </Label>
                          </div>
                            ...
                            <Checkbox
                              ...
                              onCheckedChange={(checked) => {
                                if (checked) {
                                  ...
                                  setSelectedTagIds(
                                    selectedTagIds.filter((id) => id !== t._id)
                                  );
                                }
                              }}
                            />
                            <Label
                              htmlFor={`tag-select-create-${t._id}`}
                              className="cursor-pointer font-normal"
                            >
                              {t.name}
                            </Label>
                    ...
                    {editingNote && editingNote._id === note._id && (
                      ...
                      >
                        <DialogContent className="w-[550px] flex flex-col gap-y-4">
                          ...
                          >
                            <div>
                              <Label className="my-4" htmlFor="title-edit">
                                Title
                              </Label>
                              <Input
                                id="title-edit"
                                ...
                                {allTags.map((t) => (
                                  ...
                                  >
                                    <Checkbox
                                      ...
                                      checked={editSelectedTagIds.includes(
                                        t._id
                                      )}
                                      onCheckedChange={(checked) => {
                                        if (checked) {
